...
export default function HomePage() {
  ...
  return (
    <main>
      <h1>Keepalive</h1>
      <p>
        GitHub Actions ping <code>/health</code> and <code>/health/db</code> every 8 minutes.
        Use the buttons to check app health or database health, or to push a random note.
      </p>
